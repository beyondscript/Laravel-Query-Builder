...
Route::patch('/update/data/{id}', [Inputtest::class, 'update2'])->name('update2');
Route::delete('/delete/data/{id}', [Inputtest::class, 'delete'])->name('delete');
...
Route::patch('/update/data_2/{id}', [Inputtest::class, 'update4'])->name('update4');
Route::delete('/delete/data_2/{id}', [Inputtest::class, 'delete2'])->name('delete2');
